...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<h1>404 Not Found</h1>
				<h3>Unable to find this page</h3>
				<a class="btn btn-default" href="http://localhost:8080/farm/" role="button"> <span
					class="glyphicon glyphicon-shopping-cart"></span> Click Here to
					return to Home Page
				</a>
			</div>
			<div class="col-md-4"></div>
